...
public class Volcano_Check_List_1 extends AppCompatActivity {
    private static final String LOG_TAG = Volcano_Check_List_1.class.getSimpleName();
...
//        getActionBar().setHomeButtonEnabled(true);
        ...
        imageView_reverse.setImageAlpha(View.INVISIBLE);
...
//        setTitleColor("red");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass( Volcano_Check_List_1.this, Volcano_Check_List_2.class);
                startActivity(intent);
                Volcano_Check_List_1.this.finish();
            }
        });
    }
