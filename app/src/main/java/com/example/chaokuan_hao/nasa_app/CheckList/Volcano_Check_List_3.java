...
public class Volcano_Check_List_3 extends AppCompatActivity {
    private static final String LOG_TAG = Volcano_Check_List_3.class.getSimpleName();
...
//        getActionBar().setHomeButtonEnabled(true);
        ...
        try {
            ...
            JSONArray volcanoJsonArray = checkListJsonObj.getJSONArray("volcano");
...
//        setTitleColor("red");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass( Volcano_Check_List_3.this, Volcano_Check_List_4.class);
                startActivity(intent);
                Volcano_Check_List_3.this.finish();
            }
        });
        imageView_reverse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass( Volcano_Check_List_3.this, Volcano_Check_List_2.class);
                startActivity(intent);
                Volcano_Check_List_3.this.finish();
            }
        });
