...
//        textView_accident_type.setText(getArguments().getString("msg2").toString());
    ...
    private class ReportAsyncTask extends AsyncTask<String, Void, List<PlaceInfo>> {
        ...
        protected List<PlaceInfo> doInBackground(String... urls) {
            ...
            String localState = "";
            if (_report_type =="建築倒塌") {
                localState = "1";
            } else if (_report_type == "火災") {
                localState = "2";
            } else if (_report_type == "人員傷亡") {
                localState = "3";
            } else if (_report_type == "其他") {
                localState = "4";
            }
            urls[0] = urls[0]  + _report_type_int_value + '/' + _latitude + '/' + _longitude + "/NULL";
            Log.d("RRRRRRR", urls[0]);
