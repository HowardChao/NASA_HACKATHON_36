...
public class Earthquake_Check_List_3 extends AppCompatActivity {
    private static final String LOG_TAG = Earthquake_Check_List_3.class.getSimpleName();
...
//        setTitleColor("red");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass( Earthquake_Check_List_3.this, Event_Map.class);
                startActivity(intent);
                Earthquake_Check_List_3.this.finish();
            }
        });
        imageView_reverse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass( Earthquake_Check_List_3.this, Earthquake_Check_List_2.class);
                startActivity(intent);
                Earthquake_Check_List_3.this.finish();
            }
        });
