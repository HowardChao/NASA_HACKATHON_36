...
public class Earthquake_Check_List_1 extends AppCompatActivity {
    private static final String LOG_TAG = Earthquake_Check_List_1.class.getSimpleName();
...
//        setTitleColor("red");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass( Earthquake_Check_List_1.this, Earthquake_Check_List_2.class);
                startActivity(intent);
                Earthquake_Check_List_1.this.finish();
            }
        });
    }
