...
public class Volcano_Check_List_5 extends AppCompatActivity {
    private static final String LOG_TAG = Volcano_Check_List_5.class.getSimpleName();
...
//        setTitleColor("red");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass( Volcano_Check_List_5.this, Event_Map.class);
                startActivity(intent);
                Volcano_Check_List_5.this.finish();
            }
        });
        imageView_reverse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass( Volcano_Check_List_5.this, Volcano_Check_List_4.class);
                startActivity(intent);
                Volcano_Check_List_5.this.finish();
            }
        });
