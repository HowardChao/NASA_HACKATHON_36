...
import com.example.chaokuan_hao.nasa_app.VolcanoAlarm.QueryUtils_2;
...
public class DisasterService extends Service {
    ...
    Double mDistance = QueryUtils_2.getDistance(mUserLat, mUserLng, mDisasterLat, mDisasterLng);
    ...
    final Runnable mCheckDisasterRunnable = new Runnable() {
        ...
        public void run() {
            ...
            String request = QueryUtils_2.makeHTTPRequest(QueryUtils_2.MainUrl + "/trigger");
