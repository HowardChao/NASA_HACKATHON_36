...
//    private JSON_Parsing_Hospital json_parsing_hospital = new JSON_Parsing_Hospital();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_left_menu);
...
//    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if ( id == R.id.activity_main_menu_ic_main_page){
            ...
            Intent intent = new Intent();
            intent.setClass( MapActivity.this, BasicInformation.class);
            startActivity(intent);
            MapActivity.this.finish();
        } else if (id == R.id.activity_main_menu_ic_addi_knowledge) {
            Intent intent = new Intent();
            intent.setClass( MapActivity.this, AdditionalKnowledge.class);
            startActivity(intent);
            MapActivity.this.finish();
            ...
            Intent intent = new Intent();
            intent.setClass( MapActivity.this, CoreportActivity.class);
            startActivity(intent);
            MapActivity.this.finish();
        }
...
//    }
    ...
    private void init(){
        ...
        mPolice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mMap.setInfoWindowAdapter(new Adapter_PlaceInfo(MapActivity.this));
                ...
                if( Police_Buttom_is_clicked == true ){
                    ...
                    Toast.makeText( MapActivity.this, "關起警察局圖例", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText( MapActivity.this, "打開警察局圖例", Toast.LENGTH_SHORT).show();
        ...
        mFireDep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( FireDep_Buttom_is_clicked == true ){
                    ...
                    Toast.makeText( MapActivity.this, "關起消防局圖例", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText( MapActivity.this, "打開消防局圖例", Toast.LENGTH_SHORT).show();
        ...
        mEmergencyPlace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( EmergencyPlace_Buttom_is_clicked == true ){
                    ...
                    Toast.makeText( MapActivity.this, "關起緊急避難場所圖例", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText( MapActivity.this, "打開緊急避難場所圖例", Toast.LENGTH_SHORT).show();
        ...
        mAED.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AED_Buttom_is_clicked == true) {
                    ...
                    Toast.makeText(MapActivity.this, "關起AED圖例", Toast.LENGTH_SHORT).show();
                } else if (AED_Buttom_is_clicked == false) {
                    AED_Buttom_is_clicked = true;
                    TextView textView = (TextView) findViewById(R.id.aed_textview);
                    textView.setText("關閉圖例");
                    Toast.makeText(MapActivity.this, "打開AED圖例", Toast.LENGTH_SHORT).show();
                }
                try {
        ...
        mConvenientStore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Convenient_Buttom_is_clicked == true) {
                    ...
                    Toast.makeText( MapActivity.this, "關起便利商店圖例", Toast.LENGTH_SHORT).show();
                } else if (Convenient_Buttom_is_clicked == false) {
                    Convenient_Buttom_is_clicked = true;
                    TextView textView = (TextView) findViewById(R.id.convenient_textview);
                    textView.setText("關閉圖例");
                    Log.d("TOAST", "toast before");
                    Toast.makeText( MapActivity.this, "打開便利商店圖例", Toast.LENGTH_SHORT).show();
                }
                try {
        ...
        mHospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Hospital_Buttom_is_clicked == true) {
                    ...
                    textView.setText("醫院");
                    Toast.makeText(MapActivity.this, "關起醫院圖例", Toast.LENGTH_SHORT).show();
                } else if (Hospital_Buttom_is_clicked == false) {
                    Hospital_Buttom_is_clicked = true;
                    TextView textView = (TextView) findViewById(R.id.hospital_textview);
                    textView.setText("關閉圖例");
                    Toast.makeText(MapActivity.this, "打開醫院圖例", Toast.LENGTH_SHORT).show();
                }
                try {
