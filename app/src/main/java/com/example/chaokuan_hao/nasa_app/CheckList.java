...
//import com.example.chaokuan_hao.nasa_app.Utils.SectionPagerAdapter;
...
//    private Context mContext = CheckList.this;
//
...
//        setContentView(R.layout.activity_check_list_left_menu);
//
...
//            Intent intent = new Intent();
//            intent.setClass( CheckList.this, MainActivity.class);
//            startActivity(intent);
//        } else if ( id == R.id.activity_main_menu_ic_basic_information){
//            Intent intent = new Intent();
//            intent.setClass( CheckList.this, BasicInformation.class);
//            startActivity(intent);
//        } else if (id == R.id.activity_main_menu_ic_addi_knowledge) {
//            Intent intent = new Intent();
//            intent.setClass( CheckList.this, AdditionalKnowledge.class);
//            startActivity(intent);
//        } else if ( id == R.id.activity_main_menu_ic_map ) {
//            Intent intent = new Intent();
//            intent.setClass( CheckList.this, MapActivity.class);
//            startActivity(intent);
//        } else if (id == R.id.activity_main_menu_ic_coreport ) {
//            Intent intent = new Intent();
//            intent.setClass( CheckList.this, CoreportActivity.class);
//            startActivity(intent);
//        }
//        DrawerLayout drawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout_checklist);
