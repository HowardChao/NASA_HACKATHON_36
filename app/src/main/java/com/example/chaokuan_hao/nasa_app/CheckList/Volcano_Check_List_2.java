...
public class Volcano_Check_List_2 extends AppCompatActivity {
    private static final String LOG_TAG = Volcano_Check_List_2.class.getSimpleName();
...
//        setTitleColor("red");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass( Volcano_Check_List_2.this, Volcano_Check_List_3.class);
                startActivity(intent);
                Volcano_Check_List_2.this.finish();
            }
        });
        imageView_reverse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass( Volcano_Check_List_2.this, Volcano_Check_List_1.class);
                startActivity(intent);
                Volcano_Check_List_2.this.finish();
            }
        });
